...
import { faHeartbeat, faSmile, faLaugh, faBrain, faLightbulb, faBell, faPills, faCheckCircle, faExclamationCircle, faWalking } from "@fortawesome/free-solid-svg-icons";
...
export default function CarePortal() {
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4 care-portal-header"><FontAwesomeIcon icon={faHeartbeat} /> Care Portal</h2>

      <div className="row">
        <div className="col-md-6">
          <div className="card p-4 wellbeing-card">
        ...
        <div className="col-md-6">
          <div className="card p-4 reminders-card">
            <h2 className="text-center mb-4 reminders-header"><FontAwesomeIcon icon={faBell} /> Reminders</h2>
            <div className="form-group">
              <label htmlFor="medicationInput" className="label"><FontAwesomeIcon icon={faPills} /> Medication:</label>
              <input
                type="text"
                id="medicationInput"
            ...
            <button className="btn btn-success btn-block mb-2 reminders-button">
              <FontAwesomeIcon icon={faCheckCircle} /> Did you take your medications?
            </button>
